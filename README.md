...
**Invia PDF e foto a OneDrive** (in fondo a ogni indagine o campagna) prepara i PDF, le foto e gli allegati con nomi leggibili
e apre la condivisione di Android: scegli OneDrive e la cartella. Chrome accetta al massimo 10 file per volta,
quindi con molte foto l'invio avviene a gruppi (un tocco su "Condividi" per gruppo).
Il salvataggio automatico diretto su OneDrive, senza passare dalla condivisione, richiederebbe una registrazione dell'app su Microsoft Entra ID.
